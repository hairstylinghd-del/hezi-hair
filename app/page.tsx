...
export default function Home() {
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    navItem:(activ boolean) display:'flex', alignItems:'center', gap:10, padding:'9px 12px', borderRadius:8, cursor:'pointer', color: active ? '#a78bfa' : '#9090a8', background: active ? 'rgba(124,106,255,0.12)' : 'transparent', fontWeight: active ? 600 : 500, fontSize:14, marginBottom:2, transition:'all 0.15s' }),
